/*jslint sloppy: true, plusplus:true, vars:true, bitwise:true  */
/*globals Ext, SOP*/

Ext.define("SOP.model.Party", {
    extend: "Ext.data.Model",
    requires: ["SOP.model.Track", "SOP.domain.SopBase", "Ext.Array"],
    ...
    statics: {
        ...
        loadActivePartiesForLoggedinUser: function (callback) {
            var that = this;
            SOP.domain.SopBase.getActiveParties(function (party_infos) {
    ...
    getActions: function () {
        var that = this;
        SOP.domain.SopBase.getActions(this.get('id'), function (actions) {
            that.feed(actions);
        });
    },
